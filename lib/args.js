...
module.exports = function (proto) {
  ...
  // http://www.graphicsmagick.org/GraphicsMagick.html#details-levelColors
  proto.levelColors = function levelColors (blackColor, whiteColor) {
    var colorArgs = whiteColor ? `${blackColor}, ${whiteColor},` : `${blackColor},`
    return this.out("+level-colors", colorArgs);
  }
  // http://www.graphicsmagick.org/GraphicsMagick.html#details-levelColorsMinus
  proto.levelColorsMinus = function levelColorsMinus (blackColor, whiteColor) {
    var colorArgs = whiteColor ? `${blackColor}, ${whiteColor},` : `${blackColor},`
    return this.out("-level-colors", colorArgs);
  }
